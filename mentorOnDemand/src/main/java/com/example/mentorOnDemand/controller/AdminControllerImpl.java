...
import com.example.mentorOnDemand.service.AdminServiceImpl;
...
public class AdminControllerImpl {
	...
	@ResponseBody
	public ModelAndView TechDetails(@PathVariable("id") int id, ModelMap model)throws SQLException {
		System.out.println("inside post method");
	...
	@ResponseBody
	public ModelAndView TechRemove(@PathVariable("id") int id, ModelMap model)throws SQLException {
		System.out.println("inside post method");
		//System.out.println(companyService.editCompany(company_code));
